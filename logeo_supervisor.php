...
if (isset($_POST['iniciar_sesion'])) {
    ...
    $stmt = $conn->prepare("SELECT contraseña_super FROM registro_supervisor WHERE usuario_super = ?");
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            background: linear-gradient(-45deg, #a2d5a2, #6c9a6c, #c8e6c9, #a5d6a7);
...
<body>
    <div class="container">
        <h2>Inicio de Sesión Supervisor</h2>
